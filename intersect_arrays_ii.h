...
namespace intersect_arrays_ii
{
    std::vector<int> brut_force_solution(const std::vector<int>& nums1, const std::vector<int>& nums2)
    {
        std::vector<int> res;
    ...
    std::vector<int> sort_solution(std::vector<int>& nums1, std::vector<int>& nums2)
    {
    ...
    std::vector<int> run(std::vector<int> nums1, std::vector<int> nums2, 
