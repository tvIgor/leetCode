...
namespace two_sums
{
    std::vector<int> generateArray(int size, int target)
    {
    ...
    std::vector<int> brut_force_solution(std::vector<int>& nums, int target)
    {
    ...
    std::vector<int> sort_solution(std::vector<int>& nums, int target)
    {
    ...
    void run(std::vector<int> vec, int target, std::function<std::vector<int>(std::vector<int>&, int)> alg)
    {
