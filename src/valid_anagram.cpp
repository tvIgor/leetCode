...
static bool sort_solution(std::vector<int> col1, std::vector<int> col2)
{
...
static bool map_solution(std::vector<int> col1, std::vector<int> col2)
{
  if (col1.size() != col2.size())
    return false;
...
static void run(const std::vector<int>& col1, const std::vector<int>& col2, std::function<bool(std::vector<int>, std::vector<int>)> alg)
{
